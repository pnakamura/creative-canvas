...
export const Toolbar: React.FC<ToolbarProps> = ({ onExecuteFlow }) => {
  ...
  const sourceNodes = [
    ...
    { type: 'fileUpload' as NodeType, label: 'File Upload', icon: File, color: 'text-emerald-400' },
  ...
  const processorNodes = [
    ...
    { type: 'router' as NodeType, label: 'Conditional Router', icon: GitBranch, color: 'text-amber-400' },
